<%-- 
    Document   : nethraReview
    Created on : Dec 22, 2014, 5:12:07 PM
    Author     : aryner
--%>
...
<%
	...
	boolean a = true;
	Photos nethra = (Photos)request.getAttribute("nethra");
...
<!--Questions-->
<div class="questions">
<form action="updateNethra" method="POST">
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getNotch_hrs_one()+"";
		s2 = nethra.getNotch_hrs_one()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getNotch_hrs_two()+"";
		s2 = nethra.getNotch_hrs_two()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	v2 = -1;
	if(a) {
		v1 = nethra.getErosion();
		v2 = nethra.getErosion();
		if(v1 == v2) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getEros_hrs_one()+"";
		s2 = nethra.getEros_hrs_one()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getEros_hrs_two()+"";
		s2 = nethra.getEros_hrs_two()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getDisc_hrs_one()+"";
		s2 = nethra.getDisc_hrs_one()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getDisc_hrs_two()+"";
		s2 = nethra.getDisc_hrs_two()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getRnfl_hrs_one()+"";
		s2 = nethra.getRnfl_hrs_one()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
...
<%
	...
	s2 = "";
	if(a) {
		s1 = nethra.getRnfl_hrs_two()+"";
		s2 = nethra.getRnfl_hrs_two()+"";
		if(s1.equals(s2)) {
			diff = false;
		}
		else {
