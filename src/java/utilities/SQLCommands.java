				...
				switch (type) {
					...
					case BaseTest.OCT :
						current = new OCTtest(resultSet.getInt("id"),resultSet.getInt("confirmed"),resultSet.getString("pictureName"),
						       ...
						       resultSet.getString("oct_snum"),resultSet.getString("oct_snum_os_os"),
						       resultSet.getInt("oct_scol"),resultSet.getInt("oct_scol_os_os"),
						       resultSet.getString("oct_nnum"),resultSet.getString("oct_nnum_os_os"),
						       resultSet.getInt("oct_ncol"),resultSet.getInt("oct_ncol_os_os"),
						       resultSet.getString("oct_inum"),resultSet.getString("oct_inum_os_os"),
						       resultSet.getInt("oct_icol"),resultSet.getInt("oct_icol_os_os"),
						       resultSet.getString("oct_tnum"),resultSet.getString("oct_tnum_os_os"), 
